# KorGE-ECS Sample Game

This is a tiny sample game that showcases how to initialize and use KorGE-ECS.

Everything that follows comes from the original "hello world" template; ignore if you want.
